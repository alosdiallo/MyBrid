...
foreach $intensity_file_name ( keys %tfIntensity ) {
		...
		system ("/heap/UMassProject/scripts/1to4/norm_values.pl $intensityFile mediansN.txt");
		print "\t/heap/UMassProject/scripts/1to4/norm_values.pl $intensityFile mediansN.txt\n";
