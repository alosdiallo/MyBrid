...
foreach $intensity_file_name ( keys %tfIntensity ) {
		...
		system ("/heap/UMassProject/scripts/5to8/norm_values.pl $intensityFile mediansN.txt");
		print "\t/heap/UMassProject/scripts/5to8/norm_values.pl $intensityFile mediansN.txt\n";
