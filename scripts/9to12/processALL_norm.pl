...
foreach $intensity_file_name ( keys %tfIntensity ) {
		...
		system ("/heap/UMassProject/scripts/9to12/norm_values.pl $intensityFile mediansN.txt");
		print "\t/heap/UMassProject/scripts/9to12/norm_values.pl $intensityFile mediansN.txt\n";
