...
foreach $intensity_file_name ( keys %tfIntensity ) {
		...
		system ("/heap/UMassProject/scripts/9to12/program3.pl $intensityFile mediansN.txt");
		print "\t/heap/UMassProject/scripts/9to12/program3.pl $intensityFile mediansN.txt\n";
